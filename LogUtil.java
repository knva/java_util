...
public class LogUtil {
    ...
    private static String log_name = "log";// 日志文件名（前部分）
     ...
     */
    private static String update_hz = "yyyy-MM-dd";// 更新日志的频率，每天更新一次
    private static long max_log_size = 1024 * 1024 * 100;// 单个日志文件最大大小 10M
